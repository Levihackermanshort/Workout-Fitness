...
@section('content')
    ...
    <form action="{{ route('activities.store') }}" method="POST">
        ...
        <div class="form-group">
            ...
            <input type="text" id="time_spent" name="time_spent" value="{{ old('time_spent') }}" maxlength="50">
            @error('time_spent')
                <span style="color: #e74c3c; font-size: 12px;">{{ $message }}</span>
            @enderror
        </div>
        ...
        <div class="form-group">
            ...
            <input type="text" id="distance" name="distance" value="{{ old('distance') }}" maxlength="50">
            @error('distance')
                <span style="color: #e74c3c; font-size: 12px;">{{ $message }}</span>
            @enderror
        </div>
